...
def setTCDoperation(currentRule):

	# Fill TCD inlet flow array - only 1 inlet
	dummy_flow = 10.
	tcdFlows = []
	tcdFlows.append(dummy_flow)
	
	resOp = currentRule.getController().getReservoirOp()
	resOp.setWQControlDeviceFlowRatios(tcdFlows, currentRule, dummy_flow)
